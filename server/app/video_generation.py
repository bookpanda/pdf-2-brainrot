...
def add_text_to_video(video_path, marks_path, voice_path):
    ...
    while cap.isOpened():
        ...
        cv2.putText(frame, text, (x - 3, y - 3), font, font_scale, (0, 0, 0), outline_thickness, cv2.LINE_AA)  # Top-left
        cv2.putText(frame, text, (x + 3, y - 3), font, font_scale, (0, 0, 0), outline_thickness, cv2.LINE_AA)  # Top-right
        cv2.putText(frame, text, (x - 3, y + 3), font, font_scale, (0, 0, 0), outline_thickness, cv2.LINE_AA)  # Bottom-left
        cv2.putText(frame, text, (x + 3, y + 3), font, font_scale, (0, 0, 0), outline_thickness, cv2.LINE_AA)  # Bottom-right
